...
export type CollectionQuery = { __typename?: 'Query', collection?: { __typename?: 'Collection', id: string, name: string, description: string, productVariants: { __typename?: 'ProductVariantList', items: Array<{ __typename?: 'ProductVariant', id: string, name: string, price: number, productId: string, assets: Array<{ __typename?: 'Asset', id: string, name: string, mimeType: string, source: string, width: number, height: number }>, product: { __typename?: 'Product', description: string, assets: Array<{ __typename?: 'Asset', id: string, name: string, mimeType: string, source: string, width: number, height: number }> } }> } } | null };

export type CollectionsQueryVariables = Exact<{ [key: string]: never; }>;


export type CollectionsQuery = { __typename?: 'Query', collections: { __typename?: 'CollectionList', totalItems: number, items: Array<{ __typename?: 'Collection', id: string, name: string, description: string, productVariants: { __typename?: 'ProductVariantList', totalItems: number, items: Array<{ __typename?: 'ProductVariant', id: string, name: string, price: number, productId: string, product: { __typename?: 'Product', description: string, assets: Array<{ __typename?: 'Asset', id: string, name: string, mimeType: string, source: string, width: number, height: number }> }, assets: Array<{ __typename?: 'Asset', id: string, name: string, mimeType: string, source: string, width: number, height: number }> }> } }> } };
